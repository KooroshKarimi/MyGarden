...
Hinweis Gateway: Public/Group/Private nutzen strikt statische Pfadauflösung mit Trailing-Slash-Normalisierung über Nginx-`map` (`$uri_noslash` + `try_files $uri_noslash $uri_noslash/ $uri_noslash/index.html =404`), damit Pretty-URLs robust funktionieren und defekte Links nicht still zur Startseite zurückfallen.
