...
grep -nE "authelia|AUTHELIA_|/auth/|auth_unavailable|/private/|/g/|address: 'tcp://0.0.0.0:9091/auth'" docker-compose.yml infra/nginx/conf.d/default.conf infra/authelia/configuration.yml .env.example README.md
