...
grep -nE "authelia|AUTHELIA_|/auth/|auth_unavailable|/private/|/g/|path: /auth" docker-compose.yml infra/nginx/conf.d/default.conf infra/authelia/configuration.yml .env.example README.md
