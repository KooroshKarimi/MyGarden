...
grep -nE "build-public|HUGO_IMAGE|docker-compose pull hugo|politik|technik|reisen|index.xml|dossier-iran|timeline-entry|event_date" README.md scripts/build-public.sh docker-compose.yml scripts/smoke.sh
